...
// // Chatbot endpoint - simple AI-like responses
...
// // Start server
// app.listen(PORT, () => {
//   console.log(`✓ Todo Chatbot Backend running on port ${PORT}`);
...
const configuration = new Configuration({
  apiKey: process.env.OPENAI_API_KEY, // ✅ must set in .env or Vercel
});
...
// Chatbot endpoint - real OpenAI responses
